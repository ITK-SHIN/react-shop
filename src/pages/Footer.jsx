  ...
  return (
    <>
      ...
      <footer className="Footer">
        <div className="floor first-floor">리액트 쇼핑몰</div>
        <ul className="floor second-floor">
          <li className="item">
            <svg
              className="icon"
              viewBox="0 0 38 24"
        ...
        <div className="floor third-floor">
          <FaFacebook className="icon" />
          <FaInstagram className="icon" />

          <FaGithub className="icon" />
        </div>
        <div className="floor last-floor">2023.8.21 - update 진행중</div>
      </footer>
    </>
  );
};
